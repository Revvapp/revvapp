...
export default function ClientConversationScreen() {
    ...
    try {
      ...
      try {
        if (booking.detailerId) {
          const detailerSnap = await getDoc(doc(db, 'detailers', booking.detailerId));
  ...
  const detailerDisplay = booking?.businessName || booking?.detailerName || '…';
    ...
    <SafeAreaView edges={['top']} style={styles.safe}>
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          ...
          <Text style={styles.headerTitle}>{detailerDisplay}</Text>
